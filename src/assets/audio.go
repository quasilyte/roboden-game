...
func RegisterAudioResource(ctx *ge.Context, config *Config, progress *float64) {
	audioResources := map[resource.AudioID]resource.AudioInfo{
		...
		AudioTankColonyBlasterShot:      {Path: "$sfx/tank_colony_blaster.wav", Volume: -0.05},
		...
		AudioTankColonyBlasterExplosion: {Path: "$sfx/tank_colony_blaster_explosion.wav", Volume: -0.05},
