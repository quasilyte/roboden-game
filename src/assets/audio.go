...
func RegisterAudioResource(ctx *ge.Context, config *Config, progress *float64) {
	audioResources := map[resource.AudioID]resource.AudioInfo{
		...
		AudioAssaultShield:              {Path: "sfx/assault_shield.wav", Volume: +0.05},
		...
		AudioTankColonyBlasterShot:      {Path: "sfx/tank_colony_blaster.wav", Volume: -0.3},
		...
		AudioSentinelpointShot:          {Path: "sfx/sentinelpoint_shot.wav", Volume: -0.1},
		...
		AudioCenturionShot:              {Path: "sfx/centurion_shot.wav", Volume: -0.65},
		...
		AudioRepellerBeam:               {Path: "sfx/repeller_beam.wav", Volume: -0.55},
		...
		AudioIonZap1:                    {Path: "sfx/ion_zap1.wav", Volume: -0.45},
		AudioIonZap2:                    {Path: "sfx/ion_zap2.wav", Volume: -0.45},
