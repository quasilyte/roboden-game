...
func RegisterImageResources(ctx *ge.Context, config *Config, progress *float64) {
	imageResources := map[resource.ImageID]resource.ImageInfo{
		...
		ImageAchievementInfernal:       {Path: "image/achievement/infernal.png"},
		ImageAchievementLucky:          {Path: "image/achievement/lucky.png"},
		...
		ImageSentinelpointAgentTurret: {Path: "image/drones/sentinelpoint_agent_turret.png", FrameWidth: 27},
		ImageSentinelpointAgentIcon:   {Path: "image/drones/sentinelpoint_agent_icon.png"},
		...
		ImageItemEliteFleet:        {Path: "image/ui/items/elite_fleet.png"},
...
const (
	...
	ImageAchievementInfernal
	ImageAchievementLucky
	...
	ImageDarkRadar
	ImageDarkRadarHorizontal
	ImageDarkRadarVertical
	ImageDarkDPad
